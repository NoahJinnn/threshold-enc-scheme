...
#[cfg(test)]
mod test {
    use crate::ted::{send_msg, SecretSociety};
    ...
    fn test_all() {
        ...
        let mut society = SecretSociety::new(2, 1);
        println!("society: {:?}", society.actors);
        ...
        // assert!(res.is_ok());
        // assert_eq!(msg, res.unwrap().as_slice());
        // println!("Decrypted message: {:?}", String::from_utf8_lossy(res.unwrap().as_slice()));
    }
}
